    ...
    <nav class="black" role="navigation">
        <div class="nav-wrapper container">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a href="#sucursales" class="white-text evogria" rel="" id="anchorCentros">VER CENTRO DE LIQUIDACIONES</a></li>
                <li><a href="{{url('/quienes-somos')}}" class="white-text evogria" rel="" id="anchorCentros">QUIÉNES SOMOS</a></li>
