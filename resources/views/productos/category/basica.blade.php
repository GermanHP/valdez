    ...
    <nav class="nav-color">
        <div class="container">
            <div class="col s12">
                ...
                <a href="#!" class="breadcrumb">EDUCACIÓN BÁSICA</a>
            </div>
        </div>
    </nav>
    <br><br>
                                        ...
                                        <div class="card-image">
                                            @if(!empty($item->image))
                                                <img src="{{asset('img/enStock/img' . $item->image)}}"
                                                     alt="EDUCACIÓN BÁSICA" class="image-liquidacion">
                                            @endif
                                            <div class="overlay">
                                                <div class="text center-align">
                                                    <a href="{{route('reservas.makeReserva', $item->url)}}" class="yellow-text">RESERVAR</a>
                                                    <hr class="divider">
