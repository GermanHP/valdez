...
@section('content')
    <div class="parallax-container valign-wrapper" id="consulta">
            ...
            <div class="container-fluid">
                <div class="row center">
                   <div class="col s12 m12 l3 xl3">
                       <img src="img/banners/productoarrival1.png" alt="">
                   </div>
                    <div class="col s12 m12 l3 xl3">
                        <img src="img/banners/productoarrival2.png" alt="">
                    </div>
                    <div class="col s12 m12 l3 xl3">
                        <img src="img/banners/productoarrival3.png" alt="">
                    </div>
                    <div class="col s12 m12 l3 xl3">
        ...
        <div class="parallax"><img src="img/banners/landingbanner.png" alt="Unsplashed background img 3"></div>
    </div>
